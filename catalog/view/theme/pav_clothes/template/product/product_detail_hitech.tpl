            ...
            <div class="review">
                <p>
                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                        ...
                        <?php } ?>
                    <?php } ?>
                    <a href="#review-form" onclick="$('a[href=\'#tab-review\']').trigger('click');  $(document).scrollTop( $('#tab-review').offset().top );  return false;" ><?php echo $reviews; ?></a> / <a href="#review-form"  class="popup-with-form" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;" ><?php echo $text_write; ?></a></p>
            </div>
        <?php } ?>
