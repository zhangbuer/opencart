...
class ModelCatalogProduct extends Model {
    ...
    public function getProduct($product_id) {
        ...
        if ($query->num_rows) {
            ...
            // add min max price
            $price_query = $this->db->query("SELECT MIN(price) as min_price, MAX(price) as max_price FROM " . DB_PREFIX . "product_option_value WHERE product_id = ".$query->row['product_id']);
            $price_query && $product_data = array_merge($product_data, $price_query->row);
            return $product_data;
        } else {
            return false;
        }
